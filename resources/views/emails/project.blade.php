    ...
    <tr>
        ...
        <td class="container">
            <div class="content">
                ...
                <span class="preheader">Добавлен новый проект  {{ $project->name }}</span>
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
                    ...
                    <tr>
                        <td class="wrapper">
                            <p>Привет !</p>
                            <p>Для тебя новый проект. Переходим по ссылке ниже -></p>
                                ...
                                <tr>
                                    <td align="left">
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                            <tbody>
                                            <tr>
                                                <td> <a href="{{ route('projects.show', ['project' => $project]) }}" target="_blank">Смотреть проект</a> </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </td>
